  ...
  return (
    <main style={{ padding: "2rem", fontFamily: "sans-serif" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", gap: 12 }}>
        <div>
          <h1 style={{ margin: 0 }}>Generated</h1>
          <p style={{ marginTop: 8, color: "#666" }}>
            This shows the latest generated website stored in KV.
          </p>
        </div>
      ...
      {!loading && !err && !data && (
        <div style={cardStyle}>
          <b>No generated page yet.</b>
          <div style={{ marginTop: 8, color: "#666", fontSize: 13 }}>
            Execute a run, then come back here.
          </div>
        </div>
      )}
        ...
        <div style={{ marginTop: 16 }}>
          <div style={cardStyle}>
            <div style={{ fontSize: 13, color: "#666" }}>
              Project: <code>{data.projectId}</code> &nbsp; | &nbsp; Run: <code>{data.runId}</code>
            </div>
