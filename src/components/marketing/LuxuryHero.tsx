        ...
        <div className="mt-8 grid gap-8 md:grid-cols-12 md:items-end">
          <div className="md:col-span-7">
            <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.12] bg-white/[0.03] px-3 py-1 text-xs text-white/70">
              ...
              <span className="font-semibold text-white/90">trust</span>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              ...
              <Link
                ...
                className="rounded-2xl border border-white/[0.16] bg-white/[0.04] px-6 py-3 text-sm font-semibold text-white/85 hover:bg-white/[0.06] transition"
              >
                {CTA.secondary.label}
              </Link>
            ...
            <div className="rounded-3xl border border-white/[0.12] bg-white/[0.03] p-5 backdrop-blur">
              <div className="rounded-2xl border border-white/[0.10] bg-black/40 p-5">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-[11px] text-white/40">example</div>
                </div>

                <div className="mt-2 text-sm leading-relaxed text-white/80">
                  “I run a rural service business. I want a clean, professional website that feels premium.
                  Clear services, proof, and pricing guidance. Calm tone. Easy contact.”
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-[11px] text-white/40">generated</div>
                </div>
