...
export default function HomePage() {
  const BUILD_ID = "BUILD_ID_20260125_160629";
  const BUILD_ISO = "2026-01-25T03:06:29.8475727Z";
    ...
    <main className="d8-root" data-build-id={BUILD_ID} data-build-iso={BUILD_ISO}>
      ...
      <style>{
        ...
        .d8-primary{
          ...
          font-weight:900; letter-spacing:0.1px; text-decoration:none;
          color:#061018;
          background:linear-gradient(135deg, rgba(255,215,0,0.95), rgba(0,255,200,0.78));
          border:1px solid rgba(255,255,255,0.10);
        ...
        .d8-card-title{ font-weight:800; letter-spacing:0.2px; }
        ...
        .d8-chip{
          ...
          border:1px solid rgba(255,255,255,0.14); background:rgba(255,255,255,0.06); opacity:0.9;
        }
